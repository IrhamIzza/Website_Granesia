@extends('layouts.coreadmin')

@section('title', 'tables')
@section('activenavbardashboard')
<a class="nav-link " href="/admin">
@endsection
@section('activenavbartabel')
<a class="nav-link " href="/admin/tables">
@endsection
@section('activenavbarbilling')
<a class="nav-link active" href="/admin/billing">
@endsection
@section('activenavbarprofile')
